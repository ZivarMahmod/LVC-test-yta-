...
export default function AdminPage() {
  ...
  // Auto-uppdatera var 15:e sekund när activity-tabben är aktiv
  useEffect(() => {
    if (tab === 'activity') {
      fetchActiveUsers();
      const iv = setInterval(fetchActiveUsers, 15000);
      setActivityInterval(iv);
      return () => clearInterval(iv);
    } else if (activityInterval) {
  ...
  return (
    <div className="admin-page">
      ...
      <div className="admin-tabs">
        ...
        >
          Online{activeData.totalOnline > 0 ? ` (${activeData.totalOnline})` : ''}
        </button>
      </div>
