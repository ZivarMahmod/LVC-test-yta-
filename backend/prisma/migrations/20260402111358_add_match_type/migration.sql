...
INSERT INTO "new_Video" ("createdAt", "deletedAt", "deletedById", "description", "dvwPath", "fileName", "filePath", "fileSize", "id", "matchDate", "mimeType", "opponent", "seasonId", "secondaryFilePath", "teamId", "thumbnailPath", "title", "updatedAt", "uploadedById", "videoOffset") SELECT "createdAt", "deletedAt", "deletedById", "description", "dvwPath", "fileName", "filePath", "fileSize", "id", "matchDate", "mimeType", "opponent", "seasonId", "secondaryFilePath", "teamId", "thumbnailPath", "title", "updatedAt", "uploadedById", "videoOffset" FROM "Video";
DROP TABLE "Video";
